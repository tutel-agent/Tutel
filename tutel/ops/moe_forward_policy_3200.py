...
def moe_forward(x, topk_ids, topk_weights, B, B_post, C_prev, C, moe_align_sort_fn=None):
    ...
    config = {'BLOCK_SIZE_M': block_size_M, 'BLOCK_SIZE_N': 128, 'BLOCK_SIZE_K': 128, 'GROUP_SIZE_M': 8, 'num_warps': 2, 'num_stages': 1, 'waves_per_eu': 0}
    ...
    config = {'BLOCK_SIZE_M': block_size_M, 'BLOCK_SIZE_N': 64, 'BLOCK_SIZE_K': 64, 'GROUP_SIZE_M': 4, 'num_warps': 2, 'num_stages': 2, 'waves_per_eu': 2}
